...
<head>
  ...
  <title>Data jadwal pengiriman barang</title>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                  <li>
                      <a class="clickable" href="{{env('APP_URL')}}/sdlogistik"><i class="fas fa-home"></i> <span>Jadwal Pengiriman</span></a>
                  </li>
                  <li>
                      <a class="clickable" href="{{env('APP_URL')}}/sdlogistik/input"><i class="fas fa-chart-line"></i> <span>Input Hasil Pengujian</span></a>
                  </li>
                </ul>
            </section>
        </aside>
                    	...
                    	<div class="col-xs-12 col-md-8 story-upload">
                    		<div class="box box-primary">
                    			<div class="box-header with-border">
                    				<h3 class="box-title">Laporan Jadwal Pengiriman</h3>
                    			</div>
                    			<div class="box-body">
                            <div class="table-container">
                              <table style="">
                                ...
                                <tbody id="browser-analytics">
                                  @foreach($hasilUji as $hUji)
                                    <tr>
                                      <td>{{$hUji->IdPengiriman}}</td>
                                      <td>{{$hUji->IdBarang}}</td>
                                      <td>{{$hUji->NamaBarang}}</td>
                                      <td>{{$hUji->TanggalBerangkat}}</td>
                                    </tr>
                                  @endforeach
                                </tbody>
                              </table>
