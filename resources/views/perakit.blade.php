    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                  <li>
                      <a class="clickable" href="{{env('APP_URL')}}/perakit"><i class="fas fa-home"></i> <span>Status Perakitan</span></a>
                  </li>
                  <li>
                      <a class="clickable" href="{{env('APP_URL')}}/perakit/input"><i class="fas fa-chart-line"></i> <span>Input Status Perakitan</span></a>
                  </li>
                </ul>
            </section>
        </aside>
        <div class="content-wrapper">
            ...
            <section id="content-header" class="content-header">
                <h1>Daftar Perakitan</h1>
            </section>
            <section id="content-wrapper" class="content">
              <div class="row">
              	<div class="col-xs-12 col-md-8 story-upload">
              		<div class="box box-primary">
              			<!-- <div class="box-header with-border">
              				<h3 class="box-title">Laporan Perakitan</h3>
              			</div> -->
              			<div class="box-body">
                      <div class="table-container">
                        <table style="">
                          ...
                          <tbody id="browser-analytics">
                            @foreach($statusPerakitan as $statPerakitan)
                              <tr>
                                <td>{{$statPerakitan->IdPerakitan}}</td>
                                <td>{{$statPerakitan->IdPesawat}}</td>
                                <td>{{$statPerakitan->TanggalMulai}}</td>
                                <td>{{$statPerakitan->TanggalSelesai}}</td>
                              </tr>
                            @endforeach
                          </tbody>
                        </table>
