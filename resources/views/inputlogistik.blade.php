        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                  <li>
                      <a class="clickable" href="{{env('APP_URL')}}/sdlogistik"><i class="fas fa-home"></i> <span>Hasil Pengujian</span></a>
                  </li>
                  <li>
              ...
              <div class="row">
              	<div class="col-xs-12 story-upload">
              		<div class="box box-primary">
              			...
              			<div class="box-body">
              				<form id="news-submission" action="{{env('APP_URL')}}/sdlogistik/input/process" method="post">
                        {{ csrf_field() }}
              					<div class="row">
              						<div class="col-xs-12">
