        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                  <li>
                      <a class="clickable" href="{{env('APP_URL')}}/penguji"><i class="fas fa-home"></i> <span>Hasil Pengujian</span></a>
                  </li>
                  <li>
                      <a class="clickable" href="{{env('APP_URL')}}/penguji/input"><i class="fas fa-chart-line"></i> <span>Input Hasil Pengujian</span></a>
                  </li>
                </ul>
            </section>
        </aside>
                        ...
                        <table style="">
                          ...
                          <tbody id="browser-analytics">
                            @foreach($hasilUji as $hUji)
                              <tr>
                                <td>{{$hUji->IdPengujian}}</td>
                                <td>{{$hUji->IdPesawat}}</td>
                                <td>{{$hUji->NamaPesawat}}</td>
                                <td>{{$hUji->Hasilpengujian}}</td>
                                <td>{{$hUji->Komentar}}</td>
                              </tr>
                            @endforeach
                          </tbody>
